  ...
  return (
    <BodyClassName className="page-plans">
      <>
            ...
            <ul className="plan-list">
              <li className="plan-basic">
                <div>
                  ...
                  <ul>
                    <li>
                      <span className="icon-checkmark-gray" aria-hidden="true"></span>
                    ...
                    <li>
                      ...
                      <span className="visually-hidden">Not included in this plan is </span>
                      <span className="text">
              ...
              <li className="plan-pro">
                <div>
                  ...
                  <ul>
                    <li>
                      <span className="icon-checkmark-orange" aria-hidden="true"></span>
                      <span className="text">Unlimited overnight stays with No Camping Fees</span>
                    </li>
                    <li>
                      <span className="icon-checkmark-orange" aria-hidden="true"></span>
                  ...
                  <p>
                    Lorem ipsum dolor <strong>sit</strong> amet, consectetur adipiscing elit.
                  </p>
                </div>
              </li>
            </ul>
        ...
        <div className={`payment-modal ${currentDialog}`} role="dialog" hidden={dialogActive ? null : 'hidden'}>
          <header>
            <button className="btn-close-dialog" onClick={btnCloseClick} ref={closeBtnRef}>
              X
            </button>
